...
import { fetchNewProducts } from "../lib/data";
...
export default async function Page(props: { searchParams?: Promise<{ keywords?: string , categoryId?: number , ordercompleted?:string }> }) {
    ...
    const products = await fetchNewProducts(keywords , categoryId);
    ...
    return (<>
        ...
        <div className="p-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-8 font-[Cairo]">جديدنا : </h2>
