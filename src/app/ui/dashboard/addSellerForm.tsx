    ...
    return(<>
            <form onSubmit={handleSubmit}>
                ...
                <div className="sm:col-span-4 mt-3">
                    <label className="block text-[16px] font-medium text-gray-900">دائن</label>
                    <div className="mt-2">
                        <input type="number" name="creditor" id="creditor" defaultValue={0} className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"/>
                    </div>
                </div>
                <button
                    type="submit"
